...
import com.teamfixit.myburger.Model.DeliveryDetailsModel;
import com.teamfixit.myburger.Model.FoodDetailsModel;
...
public class InsertPayment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        awesomevalidation.addValidation(this, R.id.cNumber, "^4[0-9]{12}(?:[0-9]{3})?$",R.string.invalid_card_number);
