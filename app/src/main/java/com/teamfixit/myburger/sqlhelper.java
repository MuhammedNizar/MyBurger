...
public class sqlhelper extends SQLiteOpenHelper {
    ...
    public void updateDataDriver(String newdriverid,String newdrivername,
                                 String newdrivernumber,String newdriveraddress,String newdriveremail ,
                                 String newdrivervehiclemodel,String newdrivervehiclenumber,String newdriverdob,int id ){
        SQLiteDatabase database = getWritableDatabase();

        String sql = "UPDATE DRIVERDETAILS SET newdriverid = ? ,newdrivername = ? ," +
                "newdrivernumber = ?,newdriveraddress = ?,newdriveremail = ?,newdrivervehiclemodel = ?,n" +
                "ewdrivervehiclenumber = ?,newdriverdob = ? WHERE id = ?";
        SQLiteStatement statement = database.compileStatement(sql);
    ...
    public void insertDataDelivery(String edtoderid,String edtname, String edtnumber, String edtaddress
            ,String edtprice, String edtdriverid, String edtdrivername,String edtcomplete ){
        SQLiteDatabase database = getWritableDatabase();
    ...
    public void updateDataDelivery(String edtoderid,String edtname,String
            edtnumber,String edtaddress,String edtprice ,String edtdriverid,
                                   String edtdrivername,String edtcomplete,int id ){
        SQLiteDatabase database = getWritableDatabase();

        String sql = "UPDATE ONGOING SET edtoderid = ? ,edtname = ? ,edtnumber = ?," +
                "edtaddress = ?,edtprice = ?,edtdriverid = ?,edtdrivername = ?,edtcomplete = ? WHERE id = ?";
        SQLiteStatement statement = database.compileStatement(sql);
