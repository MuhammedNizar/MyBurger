...
//        driver_Add.sqLiteHelper.queryData("CREATE TABLE IF NOT EXISTS ONGOING(ID INTEGER PRIMARY KEY AUTOINCREMENT,edtoderid VARCHAR, edtname VARCHAR,edtnumber VARCHAR,edtaddress VARCHAR,edtprice VARCHAR,edtdriverid VARCHAR,edtdrivername VARCHAR, edtcomplete VARCHAR  )");
...
/*
        ...
        btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    driver_Add.sqLiteHelper.insertDataDelivery(
